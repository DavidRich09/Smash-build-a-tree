...
public class VidaManager : MonoBehaviour
{
    ...
    private ControllerSelection controller;
    ...
    void Start()
    {
        controller = ControllerSelection.GetInstancia();
        ...
        controller = controller.GetComponent<ControllerSelection>();
    }
    ...
    void Update()
    {
        //Debug.Log(jugador.transform.position.x);
