...
public class VidaManager2 : MonoBehaviour
{
    private ControllerSelection2 controller;
    ...
    void Start()
    {
        controller = ControllerSelection2.GetInstancia();
        ...
        controller = controller.GetComponent<ControllerSelection2>();
    }
