...
public class VidaManager4 : MonoBehaviour
{
    private ControllerSelection4 controller;
    ...
    void Start()
    {
        controller = ControllerSelection4.GetInstancia();
        ...
        controller = controller.GetComponent<ControllerSelection4>();
    }
